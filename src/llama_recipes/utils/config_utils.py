...
def get_dataloader_kwargs(train_config, dataset, tokenizer, mode):
        ...
        if train_config.batching_strategy == "padding":
            ...
            # Use the music-aware collator instead of HF's tokenizer.pad()-based one
            if isinstance(tokenizer, MusicTokenizer):
                kwargs["collate_fn"] = torch_default_data_collator
            else:
